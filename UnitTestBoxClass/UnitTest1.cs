...
namespace BoxClassUnitTests
{
    ...
    public class UnitTestsBoxClassConstructors
    {
        ...
        public void Constructor_3params_InCentimeters(double a, double b, double c,
                                                      double expectedA, double expectedB, double expectedC)
        {
            BoxClass p = new BoxClass(a: a, b: b, c: c, unitOfMeasure: UnitOfMeasure.centimeter);
        ...
        {
            BoxClass p = new BoxClass(a: a, b: b, unitOfMeasure: UnitOfMeasure.meter);
        ...
        {
            BoxClass p = new BoxClass(unitOfMeasure: UnitOfMeasure.milimeter, a: a, b: b);
        ...
        {
            BoxClass p = new BoxClass(unitOfMeasure: UnitOfMeasure.centimeter, a: a);
        ...
        {
            BoxClass p = new BoxClass(a, b, c, unitOfMeasure: UnitOfMeasure.centimeter);
        }
        ...
        {
            BoxClass p = new BoxClass(a, b, unitOfMeasure: UnitOfMeasure.meter);
        }
        ...
        {
            BoxClass p = new BoxClass(a, b, unitOfMeasure: UnitOfMeasure.milimeter);
        }
        ...
        {
            BoxClass p = new BoxClass(a, unitOfMeasure: UnitOfMeasure.meter);
        }
        ...
        {
            BoxClass p = new BoxClass(a, unitOfMeasure: UnitOfMeasure.centimeter);
        }
        ...
        [DataRow(0.1,0.25,0.99, 
                 250, 100, 990, UnitOfMeasure.milimeter)]
        [DataRow(0.1,0.25,0.99, 
        ...
        [DataRow(1, 0.249, 9,
                 250, 100, 99, UnitOfMeasure.milimeter)]
